<?php
  ...
  if(isset($_POST["submitUserData"])){
      ...
      if(isset($_POST["firstName"]) and !empty($_POST["firstName"])){
        ...
        //parool kontroll + 2x
        if (!isset($_POST["password"]) or empty($S_POST["password"])){
        ...
        if (!isset($_POST["confirmpassword"]) or empty($_POST["confirmpassword"])){
          $confirmpasswordError = "palun sisestada kaks korda parool!";
        } else {
          if($_POST["confirmpassword"] !=$_POST["password"]){
            $confirmpasswordError = "Sisestad paroolid pole samad!";
          }
        }
