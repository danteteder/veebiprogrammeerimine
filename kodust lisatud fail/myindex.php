<?php
  ...
  $photoList = ["tlu_astra_600x400_1.jpg", "tlu_astra_600x400_2.jpg", "tlu_astra_600x400_3.jpg"]; 
  //array ehk massiiv
  ...
  //var_dump($photoList);
  //echo $photolist[2]; 
  //kõige viimane ehk kolmas foto, kuna 0-st indekseeritud
